            ...
            <div className="container">
                <div className="header-content pt-5 pb-5">
                    <div className="inner-header inner-about">
                        ...
                        <h2   className="mb-5 mt-3">Empowering social responsibility</h2>
                    </div>
                </div>
            </div>
    </header>
    <div className="journal-banner-wrapper w-banner-img"></div>
    <div className="journal mt-5 mb-5">
            <div className="container">
                <p className="lg-gray">In-house product: <b style={{color:"#000"}}>ESG</b></p>
            ...
            <div className="container">
                    ...
                    <div id="carouselExampleDark" className="carousel carousel-dark slide">
                        ...
                        <div className="carousel-inner">
                          <div className="carousel-item active" data-bs-interval="10000">
                            <img src={WorkdetailsImages.wdImg1} className="d-block w-100" alt="..." />
                          </div>
                        </div>
                ...
                <img src={WorkdetailsImages.wdImg2} className="journal-img mt-5"></img>
                ...
                <img src={WorkdetailsImages.wdImg3} className="journal-img mt-5"></img>
                <div className="journal-content mt-5">
